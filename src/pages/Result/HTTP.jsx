            ...
            <React.Fragment key={index}>
              <tr className="border-t border-zinc-700">
                <td class="px-2 align-top">
                  <FontAwesomeIcon icon={faLock} /> {item.http.request.method}{" "}
                  <br />
                  H2
                </td>
                <td class="px-2 align-top">{item.http.response.status_code}</td>
                ...
                <td class="px-2 align-top text-left">
                  <span className="flex">
                    <div>
                      <span className="text-green-500">{data.ip}</span> <br />
                      <span className="">
                                ...
                                <div className="space-y-4">
                                  ...
                                  <div className="flex mt-2 space-x-5 ml-8">
                                    ...
                                    <div className="flex-col text-left">
                                      ...
                                      <div>{item.http.response.html_title}</div>
                                    </div>
                                  </div>
                                </div>
                              </div>
