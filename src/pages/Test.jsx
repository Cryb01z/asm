                  ...
                  {data.map((item, index) => (
                    <div key={item.user + item.comment} className="relative">
                      ...
                      >
                        ...
                        {/* full log */}
                        <div className={`absolute ${index === data.length - 1 ? "bottom-16":"top-16"} invisible group-hover:visible bg-black border border-zinc-700/60 rounded-md z-30`}>
